...
/* TODO Translate
    class FBRecordURL extends TransientFacebook {
      ...
      protected void _oauthRequest($url, $params) {
        $this->url = $url;
      }

      public void getRequestedURL() {
        return $this->url;
      }
    }

    class FBPublic extends TransientFacebook {
      public static void publicBase64UrlDecode($input) {
        return self::base64UrlDecode($input);
      }
      public void publicParseSignedRequest($input) {
    ...
    class PersistentFBPublic extends Facebook {
      ...
      public void publicSetPersistentData($key, $value) {
        $this->setPersistentData($key, $value);
      }
    }

    class FBCode extends Facebook {
      public void publicGetCode() {
        return $this->getCode();
      }
